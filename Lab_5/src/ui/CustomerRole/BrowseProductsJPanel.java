...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Thank you for your purchase, Logking forward to see you again.");
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        item.getProduct().setAvail(item.getProduct().getAvail() +item.getQuntity());
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        OrderItem item = (OrderItem) tblCart.getValueAt(selectedRowIndex, 0);
        ViewOrderItemDetailJPanel votdjp = new ViewOrderItemDetailJPanel(userProcessContainer, item);
        userProcessContainer.add("ViewOrderItemDetailJPanel", votdjp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout ();
        layout. next (userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (salesPrice < product.getPrice()){
            JOptionPane.showMessageDialog(this, "Price shoulde be more than it is set in the price."); 
            return;
        }
    ...
    private void populateCartTable(){
        ...
        for (OrderItem oi : currentOrder.getOrderItemList()) {
            ...
            row[2] = oi.getQuntity();
            row[3] = oi.getQuntity() * oi.getSalesPrice();
            model. addRow(row);
    }
}
