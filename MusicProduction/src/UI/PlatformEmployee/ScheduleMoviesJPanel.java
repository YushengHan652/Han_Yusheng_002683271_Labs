...
import System.Platform.TimePeriod;
...
public class ScheduleMoviesJPanel extends javax.swing.JPanel {
    ...
    public ScheduleMoviesJPanel(JPanel workArea, UserAccount account, CinemaRequest crq, MusicStudioSystem system) {
        initComponents();
        ...
        for(Network network:system.getNetworkList()) {
            for (Studio studio: network.getEnterpriseDirectory().getEnterpriseList()) {
                for(Organization org: studio.getOrganizationDirectory().getOrganizationList()) {
                    for(UserAccount ua: org.getUserAccountDirectory().getUserAccountList()) {
                        if (ua == account) {
                            for(TimePeriod tp: studio.getTimePeriodDirectory().getTimePeriodList()) {
                                model.addElement(tp);
                            }
                        }
                    }
