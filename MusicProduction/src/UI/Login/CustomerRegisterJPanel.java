...
import System.ConnectDB.ConnectDB;
...
public class CustomerRegisterJPanel extends javax.swing.JPanel {
    ...
    public CustomerRegisterJPanel(JPanel mainWorkArea, MusicStudioSystem system) {
        initComponents();
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ConnectDB resgistercon = new ConnectDB();
        Connection conn = resgistercon.getConnection();
        String querys = "insert into customers (id, name, pwd, pwdconfirm, email, gender)\"\n" + 
"                + \" values(?, ?, ?, ?, ?, ?)";
        ...
        if (!pwd.equals(pwdconfirm)) {
            ...
            for(Network network: system.getNetworkList()) {
                for (Studio studio: network.getEnterpriseDirectory().getEnterpriseList()) {
                    if (studio.getEnterpriseType().toString().equals("CustomerEn")) {
            ...
            try {
                ...
                pstmt.setString(4, pwdconfirm);
                pstmt.setString(5, email);
                pstmt.setString(6, gender);
                pstmt.executeUpdate();
                JOptionPane.showMessageDialog(mainWorkArea, "User Registered Sucessful.");
