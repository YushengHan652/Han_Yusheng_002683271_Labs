...
public class LoginSystemAdminJPanel extends javax.swing.JPanel {
    ...
    JPanel mainWorkArea;
    JPanel menuJPanel;
    private MusicStudioSystem system;
    
    public LoginSystemAdminJPanel(JPanel mainWorkArea, JPanel menuJPanel, MusicStudioSystem system) {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        for(Network network:system.getNetworkList()) {
            for (Studio studio:network.getEnterpriseDirectory().getEnterpriseList()) {
                for (Organization organization:studio.getOrganizationDirectory().getOrganizationList()) {
