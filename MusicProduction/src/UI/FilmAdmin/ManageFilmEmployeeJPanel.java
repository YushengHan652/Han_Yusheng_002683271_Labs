...
public class ManageFilmEmployeeJPanel extends javax.swing.JPanel {
    ...
    String enName;
    public ManageFilmEmployeeJPanel(JPanel workArea, UserAccount filmAdmin, MusicStudioSystem system) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for(Network network:system.getNetworkList()) {
            for (Studio enterprise: network.getEnterpriseDirectory().getEnterpriseList()) {
