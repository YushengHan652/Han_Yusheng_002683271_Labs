...
public class ViewDataModuleJPanel extends javax.swing.JPanel {
    ...
    public ViewDataModuleJPanel(JPanel workArea,MusicStudioSystem system) {
        initComponents();
...
//        piePlot.setLabelGenerator(gen);   
    ...
    public int sumFilmAdmin(){
        ...
        for(Network network:system.getNetworkList()) {
            for (Studio studio: network.getEnterpriseDirectory().getEnterpriseList()) {
                if (studio.getEnterpriseType().toString().equals("FilmEn")) {
                    for(Organization org: studio.getOrganizationDirectory().getOrganizationList()) {
                        for(UserAccount ua: org.getUserAccountDirectory().getUserAccountList()) {
    ...
    public int sumAuditor(){
        ...
        for(Network network:system.getNetworkList()) {
            for (Studio studio: network.getEnterpriseDirectory().getEnterpriseList()) {
                if (studio.getEnterpriseType().toString().equals("ReviewEn")) {
                    for(Organization org: studio.getOrganizationDirectory().getOrganizationList()) {
                        for(UserAccount ua: org.getUserAccountDirectory().getUserAccountList()) {
