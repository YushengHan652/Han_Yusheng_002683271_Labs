...
public class ManageCinemaAdminJPanel extends javax.swing.JPanel {
    ...
    public ManageCinemaAdminJPanel(JPanel workArea, MusicStudioSystem system) {
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (name.isEmpty() || pwd.isEmpty()) {
            ...
            for(Network network: system.getNetworkList()) {
               ...
               if(i==0){
                   Studio cinemaEn = network.getEnterpriseDirectory().createAndAddEnterprise(name, Studio.EnterpriseType.CinemaEn);
