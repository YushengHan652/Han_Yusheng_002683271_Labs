...
public class ManageFilmAdminJPanel extends javax.swing.JPanel {
    ...
    public ManageFilmAdminJPanel(JPanel workArea, MusicStudioSystem system) {
        initComponents();
        ...
        if (name.isEmpty() || pwd.isEmpty()) {
            ...
            for(Network network: system.getNetworkList()) {
               for (Studio studio: network.getEnterpriseDirectory().getEnterpriseList()) {
                ...
                if(i==0){
                    Studio filmEn = network.getEnterpriseDirectory().createAndAddEnterprise(name, Studio.EnterpriseType.FilmEn);
